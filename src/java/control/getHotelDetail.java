 ...
 * @author taola
 */
@WebServlet(name = "getHotelDetail", urlPatterns = {"/getHotelDetail"})
public class getHotelDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        ses.setAttribute("hid", hid);
        HotelControl h = dao.getHotelInforFromId(pid, hid);
        ses.setAttribute("hotel", h);
